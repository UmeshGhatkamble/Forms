<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] =="POST")
    {
        ...
        $sql="SELECT reg_id FROM reg_info WHERE reg_username='$myusername' AND reg_pass='$password'";
    ...
    <html>
        ...
        <br>
            ...
            <button> <a class="" href="index.php">register here</a></button>
            <button> <a class="" href="fargot.php"> fargot password</a></button>
